...
.header { background:#0b1b30; border-bottom:1px solid #183455; position:sticky; top:0; z-index:10; }
.header-inner { display:flex; align-items:center; justify-content:space-between; gap:16px; max-width:1200px; margin:auto; padding:16px 24px; }
.logo { font-weight:900; font-size:22px; letter-spacing:.04em; }
.nav { display:flex; gap:14px; font-size:14px; color:#b7c7dc; flex-wrap:wrap; }
...
.input { background:#07182b; color:#e8f1ff; border:1px solid #244669; border-radius:10px; padding:9px 10px; width:100%; }
